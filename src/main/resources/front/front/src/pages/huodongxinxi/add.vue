...
<div :style='{"width":"1200px","padding":"20px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}'  label="养老院名称" prop="yanglaoyuanmingcheng">
            <el-select v-model="ruleForm.yanglaoyuanmingcheng" placeholder="请选择养老院名称"  >
              <el-option
          ...
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="活动封面" v-if="type!='cross' || (type=='cross' && !ro.huodongfengmian)" prop="huodongfengmian">
            <file-upload
            tip="点击上传活动封面"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' class="upload" v-else label="活动封面" prop="huodongfengmian">
          ...
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="活动类型" prop="huodongleixing">
          ...
          <el-form-item :style='{"border":"3px solid #c6ecc6","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="活动时间" prop="huodongshijian" >
              <el-date-picker
