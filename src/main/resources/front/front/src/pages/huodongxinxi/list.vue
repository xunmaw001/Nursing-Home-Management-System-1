...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"30px 10px 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
        ...
        <el-select v-model="formSearch.yanglaoyuanmingcheng" placeholder="请选择养老院名称" :clearable="true">
          <el-option v-for="(item, index) in yanglaoyuanmingchengOptions" :key="index" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	  ...
	  <el-button v-if="isAuth('huodongxinxi','新增')" :style='{"cursor":"pointer","padding":"0px 10px","margin":"0 4px 0 0","borderColor":"#fda100","color":"#fda100","outline":"none","borderRadius":"4px","background":"#fcf2e1","borderWidth":"1px 4px","width":"auto","fontSize":"14px","lineHeight":"42px","borderStyle":"solid","height":"42px"}' type="primary" @click="add('/index/huodongxinxiAdd')"><i v-if="true" :style='{"color":"#fda100","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"margin":"20px 0 10px","background":"none"}'>
		...
		<div class="list1 index-pv1" :style='{"padding":"0 10px","margin":"30px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"padding":"10px","boxShadow":"0px 2px 6px #e6e6e6","margin":"0 0 20px","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","width":"23.5%","position":"relative","justifyContent":"space-between","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"cursor":"pointer","width":"100%","margin":"0 0 8px","objectFit":"cover","display":"block","height":"275px"}' v-if="item.huodongfengmian && item.huodongfengmian.substr(0,4)=='http'" :src="item.huodongfengmian" class="image" />
				<img :style='{"cursor":"pointer","width":"100%","margin":"0 0 8px","objectFit":"cover","display":"block","height":"275px"}' v-else :src="baseUrl + (item.huodongfengmian?item.huodongfengmian.split(',')[0]:'')" class="image" />
...
<script>
  export default {
    ...
    created() {
      ...
      this.$http.get('option/yanglaoyuanxinxi/yanglaoyuanmingcheng').then(res => {
        if (res.data.code == 0) {
          this.yanglaoyuanmingchengOptions = res.data.data;
        }
      });
      this.getFenlei();
      this.getList(1, '全部');
